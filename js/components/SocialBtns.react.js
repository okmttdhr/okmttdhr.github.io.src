  ...
  render() {
    return (
      <div className='SocialBtns mb-30 clearfix'>
        ...
        <a className='SocialBtns__btn SocialBtns__btn--mmm' href='https://www.google.co.jp/webhp?sourceid=chrome-instant&ion=1&espv=2&ie=UTF-8#q=site%3Ablog.mmmcorp.co.jp%20okp' target='_blank' />
      </div>
    );
  }
}
